...
export const userRegisterReducer = (state : any = {}, action : any) => {
    switch(action.type) {
...
export const userDetailsReducer = (state: any = {loading: true}, action: any) => {
    switch(action.type) {
...
export const userUpdateProfileReducer = (state: any = {loading: true}, action: any) => {
    switch(action.type) {
